...
## 2. Tone of Voice: "The Local Artisan"

- **The Persona:** A "Knowledgeable Local Friend" who is helpful, warm, and authoritative.
...
- **Utility Over Hype:** Never use marketing fluff. If a venue is expensive, call it "Premium-priced." If it's basic, call it "Functional and focused."
    

## 3. UX Principles: "Frictionless Discovery"

- **Mobile-First Utility:** Mobile view is a "tool" (prioritize 'Directions' and 'Call' buttons); Desktop view is a "resource" (prioritize 'Comparison' and 'Deep Research').
