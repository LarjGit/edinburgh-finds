...
- [x] Task: Analyze `prisma/schema.prisma` against `product.md`. [analysis_completed]
...
- [x] Task: Review `engine/seed_data.py` and data flow. [analysis_completed]
...
- [x] Task: Review Next.js Project Structure. [analysis_completed]
