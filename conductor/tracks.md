...
**Note:** All tracks have been archived as of 2026-01-24. Active development should begin with new tracks in `conductor/tracks/`.

---

## [x] Track: Intelligent Ingestion Orchestration
*Link: [./conductor/archive/intelligent_ingestion_orchestration_20260123/](./conductor/archive/intelligent_ingestion_orchestration_20260123/)*
**Status:** Complete
**Completed:** 2026-01-24
**Priority:** High
**Description:** Implemented the Intelligent Ingestion Orchestration - Architecture v6 to provide a runtime-safe, phase-ordered, and intelligent control plane for the data ingestion engine. Completed all 5 phases: (1) Core Types, Features & Safe DSL, (2) Execution Context & Deduplication, (3) Execution Plan & Phase Barriers, (4) Orchestrator & Integration, (5) Final Verification. Deliverables include immutable core types, safe condition DSL, deterministic deduplication, phase-based execution plan, and main orchestrator. 143 tests passing with 99% code coverage. Fully spec-compliant and production-ready.

---

## [x] Track: Conductor Documentation Synchronization
*Link: [./conductor/archive/conductor_sync_20260123/](./conductor/archive/conductor_sync_20260123/)*
**Status:** Complete
...
*Link: [./conductor/archive/engine_purity_remediation_20260122/](./conductor/archive/engine_purity_remediation_20260122/)*
**Status:** Complete
...
*Link: [./conductor/archive/engine_purity_finalization_20260121/](./conductor/archive/engine_purity_finalization_20260121/)*
**Status:** Complete
...
## [x] Track: Complete Engine-Lens Architecture
*Link: [./conductor/archive/complete_engine_lens_architecture_20260119/](./conductor/archive/complete_engine_lens_architecture_20260119/)*
**Status:** Archived (Incomplete - Phases 1-3 complete, Phases 4-5 pending)
**Archived:** 2026-01-24
**Priority:** Critical
**Description:** Finalize the Engine-Lens separation by migrating to Supabase (Postgres) and removing all remaining legacy/vertical-specific code. Addresses blockers: SQLite limitations, Engine Purity violations, and Classification logic errors. Completed Phase 1 (Database Migration), Phase 2 (Engine Purity & Cleanup), and Phase 3 (Logic & Semantics). Phases 4-5 (Re-ingestion & Validation, Frontend Integration) remain pending.

---

## [x] Track: Engine-Lens Architecture Refactor
*Link: [./conductor/archive/engine_lens_architecture_20260118/](./conductor/archive/engine_lens_architecture_20260118/)*
**Status:** Archived (Not Started)
**Archived:** 2026-01-24
**Priority:** Critical
...
*Link: [./conductor/archive/pytest_collection_conflicts_20260118/](./conductor/archive/pytest_collection_conflicts_20260118/)*
**Status:** Complete
...
*Link: [./conductor/archive/prisma_schema_generation_20260118/](./conductor/archive/prisma_schema_generation_20260118/)*
**Status:** Complete
**Completed:** 2026-01-18
...
*Link: [./conductor/archive/universal_entity_model_refactor_20260117/](./conductor/archive/universal_entity_model_refactor_20260117/)*
**Status:** Complete
...
*Link: [./conductor/archive/category_entity_decoupling_20260117/](./conductor/archive/category_entity_decoupling_20260117/)*
**Status:** Complete
**Completed:** 2026-01-17
...
*Link: [./conductor/archive/data_extraction_engine_20260115/](./conductor/archive/data_extraction_engine_20260115/)*
**Status:** Complete
...
*Link: [./conductor/archive/yaml_schema_source_of_truth_20260116/](./conductor/archive/yaml_schema_source_of_truth_20260116/)*
**Status:** Complete
...
*Link: [./conductor/archive/entity_type_refactor_20260114/](./conductor/archive/entity_type_refactor_20260114/)*
**Status:** Complete
...
*Link: [./conductor/archive/arch_alignment_20260114/](./conductor/archive/arch_alignment_20260114/)*
**Status:** Complete
...
**Description:** Established frontend foundation with Next.js, React, TypeScript, and Tailwind CSS.
...
**Description:** Core architecture refactoring and foundation establishment.

---

## Future Track Ideas

### Ecosystem Graph - Relationship Extraction
**Status:** Planned (Not Started)
**Dependencies:** Data Extraction Engine
**Description:** Extract and validate relationships between entities (coaches→venues, clubs→venues, events→venues) to build the ecosystem graph. Populate `ListingRelationship` table with relationship types (teaches_at, plays_at, based_at, etc.) using LLM analysis of discovered_attributes and cross-entity references. Enable hyper-specific SEO pages ("Coaches at [Venue]", "Clubs in [Area]"). Implement relationship confidence scoring and business claim verification workflow.

---

## Archive Notes

All tracks have been archived to maintain a clean development slate. When creating new tracks:

1. Create track directory in `conductor/tracks/<track_name>/`
2. Include `spec.md`, `plan.md`, and `metadata.json`
3. Update this registry file
4. Follow the Conductor workflow protocols

For historical reference, all archived tracks are preserved in `conductor/archive/`.
